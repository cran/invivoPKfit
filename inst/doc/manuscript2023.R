...
## ----sFig4-model_performance, eval=FALSE--------------------------------------
...
## ----fig4-modelPerform-v-dataVar, eval=FALSE----------------------------------
...
## ----fig5-goodness-of-fit, eval=FALSE-----------------------------------------
...
## ----goodness-of-fit_exampleFits, eval = FALSE--------------------------------
...
## ----sFig7-sigmaDistribution, eval=FALSE--------------------------------------
#  
#  my_pk$fit %>%
...
## ----sfig5-examples-of-fits, eval=FALSE---------------------------------------
