...
The purpose of Figure 3 is to illustrate the variability among replicate
...
This alternate version of Figure 3A aims to simplify the assessment of replication
...
```{r sFig2-cvt_analysis, eval=FALSE}
...
```{r fig4-modelPerform-v-dataVar, eval=FALSE}
...
```{r fig5-goodness-of-fit, eval=FALSE}
...
```{r sFig7-sigmaDistribution, eval=FALSE}
...
```{r sfig5-examples-of-fits, eval=FALSE}
